...
span.onclick = function () {
  ...
  document.getElementById(
    "en"
  ).src = `assets/s07 en/s07 (${episode.innerHTML}).vtt`;
  document.getElementById(
    "ar"
  ).src = `assets/s07 ar/s07 (${episode.innerHTML}).vtt`;
};
...
epis.forEach((epi, i) => {
  epi.addEventListener("click", function () {
    ...
    {
      video.src = `https://archive.org/download/s-07-16/s07%20%28${
        i + 1
      }%29.mkv`;
      video.play();
    }
...
shuffle.onclick = function () {
  ...
  console.log(rnd);
  {
    video.src = `https://archive.org/download/s-07-16/s07%20%28${rnd}%29.mkv`;
    video.play();
  }
  {
